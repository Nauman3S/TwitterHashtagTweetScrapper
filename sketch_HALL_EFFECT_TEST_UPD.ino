...
if(message.length() < 12) { m12 = 4096 ; r12 = 0; }
if(message.length() < 11) { m11 = 4096 ; r11 = 0; }
if(message.length() < 10) { m10 = 4096 ; r10 = 0; }
if(message.length() < 9) { m9 = 4096 ; r9 = 0; }
if(message.length() < 8) { m8 = 4096 ; r8= 0; }
if(message.length() < 7) { m7 = 4096 ; r7 = 0; }
if(message.length() < 6) { m6 = 4096 ; r6 = 0; }
if(message.length() < 5) { m5 = 4096 ; r5 = 0; }
if(message.length() < 4) { m4 = 4096 ; r4 = 0; }
if(message.length() < 3) { m3 = 4096 ; r3 = 0; }
if(message.length() < 2) { m2 = 4096 ; r2 = 0; }
if(message.length() < 1) { m1 = 4096 ; r1 = 0; }
